...
'<div style="width:{width}px;height:{height}px;top:{top}px;left:{left}px;z-index:{zIndex}" class="window-container window-current" window="{num}" id="window_{num}_warp">'+
	'<div style="height: 100%;" id="window_{num}_inner">'+
		'<div class="title-bar">'+
			'{title}<div class="title-handle"><a class="ha-min" btn="hide" href="javascript:;" target="_blank" rel="external">最小化</a><a class="ha-max" btn="max" href="javascript:;" target="_blank" rel="external">最大化</a><a class="ha-revert" btn="revert" href="javascript:;" style="display:none" target="_blank" rel="external">还原</a><a class="ha-close" btn="close" href="javascript:;" target="_blank" rel="external">关闭</a></div>'+
		'</div>'+
