                        ...
                        $.each(arr, function(j, obj) {
                            ...
                            if (text) {
                                ...
                                if ($.isArray(obj.data) && obj.data.length) {
                                    ...
                                    '<a href="javascript:" class="'+ clKey +'a" '+="" strtitle="" +'="" data-key="'+ rand +'" target="_blank" rel="external"><i class="'+ clKey +'triangle"></i>'+ text +'</a>' + 
                                    '</li>';
                                } else {
                                    htmlMenuLi = '<li class="'+ clKey +'li">' +
                                    '<a href="javascript:" class="'+ clKey +'a" '+="" strtitle="" +'="" data-key="'+ rand +'" target="_blank" rel="external">'+ text +'</a>' + 
                                    '</li>';
                                }
